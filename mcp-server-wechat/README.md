...
#### 使用 fastmcp install（推荐）

```bash
PYTHONPATH=src fastmcp install src/mcp_server_wechat/server.py:mcp --name wechat-articles
```

#### 手动配置

在 Claude Desktop 配置文件中添加（配置文件位置见[官方文档](https://modelcontextprotocol.io/quickstart/user)）：
